module github.com/terrafying/byoip-mutator
...
require (
	...
	github.com/fluxcd/helm-controller v0.5.1 // indirect
...
replace k8s.io/controller-manager => k8s.io/controller-manager v0.19.8-rc.0
